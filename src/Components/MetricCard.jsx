...
const MetricCard = (props) => {
  ...
  return (
    <motion.div layout initial={{opacity:0,y:20}} animate={{opacity:1, y:0,transition: { duration: 0.5 }}} className='rounded-2xl w-[30%]  p-5 className={`w-full p-4 mb-3 flex flex-col gap-3 bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600  rounded-xl hover:shadow-md transition-shadow dark:hover:shadow-neutral-600 '>
        <h1>{props.name}</h1>
